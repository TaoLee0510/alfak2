...
for name in \
  ...
  LAMBDA_E_VALUES SIGMA_OBS_VALUES GRAPH_EDGE_WEIGHTS ALFAK2_ANCHOR_COUNT_REFERENCE \
  ALFAK2_ANCHOR_COUNT_POWER DM_CONCENTRATIONS EFFECTIVE_DEPTH_MODES \
  LOCAL_SHELL_DEPTHS GLOBAL_EXTRA_SHELLS OBJECTIVE_SCOPE OBJECTIVE_METRIC \
  DIRECT_WEIGHT HOLDOUT_WEIGHT HOLDOUT_FRACTION HOLDOUT_MIN_DIRECT HOLDOUT_FAILURE_PENALTY \
  BIAS_WEIGHT SPEARMAN_WEIGHT FALSE_HIGH_WEIGHT CAL_ARRAY_LIMIT BENCH_ARRAY_LIMIT PREPARE_TIME \
