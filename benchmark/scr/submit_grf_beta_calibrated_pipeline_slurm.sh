...
for name in \
  ...
  DIRECT_WEIGHT HOLDOUT_WEIGHT HOLDOUT_FRACTION HOLDOUT_MIN_DIRECT BIAS_WEIGHT \
  SPEARMAN_WEIGHT FALSE_HIGH_WEIGHT CAL_ARRAY_LIMIT BENCH_ARRAY_LIMIT PREPARE_TIME \
